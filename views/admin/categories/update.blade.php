...
@section('content')
    ...
    <form action="/admin/categories/update/{{ $cate['id'] }}" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <img src="{{ file_url($cate['img']) }}" width="88px" alt="">
        </div>
        ...
        <a href="/admin/categories" class="btn btn-outline-warning">Trở lại</a>
